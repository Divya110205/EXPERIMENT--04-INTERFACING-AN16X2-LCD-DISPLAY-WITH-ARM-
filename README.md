...
int main(void)
{
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
    ...
    Lcd_cursor(&lcd, 0,0);
    Lcd_string(&lcd, "DIVYA A");

    Lcd_cursor(&lcd,1,0);
        Lcd_string(&lcd, "212222230034");
        HAL_Delay(500);
  while (1)
  {
...
## Output screen shots of proteus  :
 ![3](https://github.com/Divya110205/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/119404855/884a4c84-e707-4526-87ef-d8133583c769)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/Divya110205/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/119404855/fce54940-552c-4383-b59a-7d716b662fbb)
